...
FROM (
        ...
        UNION ALL
        SELECT '红楼梦', 46.80, 5, '中国古典四大名著之首，描绘了贾、史、王、薛四大家族的兴衰', 'https://img9.doubanio.com/view/subject/l/public/s1070959.jpg', '<p>《红楼梦》是一部百科全书式的长篇小说。以宝黛爱情悲剧为主线，以四大家族的荣辱兴衰为背景，描绘出18 世纪中国封建社会的方方面面，以及封建专制下新兴资本主义民主思想的萌动。结构宏大、情节委婉、细节精致，人物形象栩栩如生，声口毕现，堪称中国古代小说中的经典。</p><p>作品以贾、史、王、薛四大家族的兴衰为背景，以富贵公子贾宝玉为视角，以贾宝玉与林黛玉、薛宝钗的爱情婚姻悲剧为主线，描绘了一些举止见识出于须眉之上的闺阁佳人的人生百态，展现了真正的人性美和悲剧美，同时也描绘了许多有血有肉的人物，展现了医道、饮食、礼仪、歌舞、诗词、布局等多方面的文化。可以说，《红楼梦》是一部中国封建社会的百科全书，传统文化的集大成者。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT 'JavaScript 高级程序设计', 99.00, 4, 'Web 前端开发圣经，全面介绍JavaScript 编程的核心概念和技术', 'https://img9.doubanio.com/view/subject/l/public/s29631195.jpg', '<p>本书是JavaScript 经典图书的最新版，涵盖ECMAScript 2019，全面涵盖JavaScript 语言核心和Web API。</p><p>书中详尽讲解了JavaScript 的起源与历史、基本概念、语法、变量、数据类型、流控制语句、函数、面向对象编程、DOM、BOM、事件流、表单、JSON、Web API、性能优化、最佳实践等重要概念和技术。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '小王子', 36.00, 5, '圣埃克苏佩里的经典童话，关于爱、责任和人生意义的探索', 'https://img3.doubanio.com/view/subject/l/public/s1103152.jpg', '<p>《小王子》是法国作家圣埃克苏佩里于1942 年写成的著名儿童文学短篇小说。它的创作源于作者在撒哈拉沙漠遇险的真实经历。</p><p>本书主要讲述了小王子从自己星球出发前往地球的过程中，所经历的各种历险。寓言式的故事结构让作者得以通过小王子的孩童视角，对人类社会的诸多荒谬及世人的盲目愚妄进行了幽默而又深刻的讽刺与批判。</p>', NOW(), NOW()
        UNION ALL
        SELECT '深入理解计算机系统', 139.00, 5, '计算机科学经典教材，透彻讲解计算机系统的工作原理', 'https://img1.doubanio.com/view/subject/l/public/s29195878.jpg', '<p>《深入理解计算机系统》是一本将计算机软件和硬件理论结合讲述的经典教材。全书共分为12 章，从程序员的视角详细阐述计算机系统的本质概念，并展示这些概念如何实实在在地影响应用程序的正确性、性能和实用性。</p><p>本书内容涵盖计算机导论、体系架构、操作系统、网络、编译原理和数据库等专业课程中的核心概念，能够帮助程序员充分理解计算机系统内部的工作原理，从而编写出更为高效、可靠的程序。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '围城', 42.00, 4, '钱钟书的代表作，描述了抗日战争时期知识分子的爱情、婚姻与生活', 'https://img1.doubanio.com/view/subject/l/public/s1070222.jpg', '<p>《围城》是钱钟书所著的长篇小说，初版于1947 年。小说以抗日战争初期为背景，通过描写主人公方鸿渐从留学归国、求职、结婚到最后分手这段人生历程，深刻揭露和批判了当时中国社会的文化和教育。</p><p>小说塑造了方鸿渐这一典型的知识分子形象，并通过他的经历讽刺了那个时代社会的种种弊病和知识分子的虚伪特性。钱钟书在小说中表达了自己对婚姻的看法："婚姻是一座围城，城外的人想进去，城内的人想出来。"</p>', NOW(), NOW()
        UNION ALL
        SELECT '流畅的Python', 109.00, 5, 'Python 进阶必读，全面介绍Python3 的新特性和编程技巧', 'https://img3.doubanio.com/view/subject/l/public/s29434304.jpg', '<p>《流畅的Python》是Python 语言的进阶读物，全书分为五个部分，共22 章，系统论述了Python 语言的特性和编程理念。作者结合自己的编程经验，深刻分析了Python 的设计思想、使用建议和最佳实践。</p><p>本书主要内容包括数据结构、函数、面向对象惯用法、控制流程和元编程等。每章都包含大量示例代码，并通过习题强化读者对所学内容的理解。书中还介绍了Python3 的许多新特性，包括但不限于新的字符串格式、并发编程、上下文管理器和描述符等。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '编译原理', 89.00, 4, '经典的编译原理教材，介绍编译器设计的基本原理与实现技术', 'https://img3.doubanio.com/view/subject/l/public/s3392161.jpg', '<p>《编译原理》(又称龙书)是编译领域的经典教材，全面、系统地讲解了编译器设计的基本原理和实现方法。本书共分为12 章，内容涵盖词法分析、语法分析、语法制导翻译、运行时环境、中间代码生成、代码优化和目标代码生成等主题。</p><p>书中不仅介绍了编译器构造的理论基础，还提供了大量的实例和练习，帮助读者深入理解复杂的编译过程。作为计算机科学的重要分支，编译原理对于理解程序设计语言的实现机制、提高程序效率都具有重要意义。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '时间简史', 45.00, 5, '霍金的科普经典，讲述宇宙起源与命运的故事', 'https://img1.doubanio.com/view/subject/l/public/s1914861.jpg', '<p>《时间简史》是著名物理学家史蒂芬·霍金写给大众的科普著作，以通俗易懂的语言介绍了时间和空间的本质、宇宙的起源与命运等复杂的物理学概念。</p><p>从爱因斯坦的相对论到量子力学，从黑洞到大爆炸理论，霍金带领读者踏上了一段探索宇宙奥秘的奇妙旅程。这本书不仅介绍了物理学的前沿成果，还展示了科学家们如何通过理论推导和实验验证来理解我们所处的这个宇宙。</p><p>《时间简史》问世后立即成为全球畅销书，被翻译成40 多种语言，销售了1000 多万册，是20 世纪最具影响力的科学著作之一。</p>', NOW(), NOW()
    ) AS new_products (
