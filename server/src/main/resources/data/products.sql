...
FROM (
        ...
        UNION ALL
        SELECT 'JavaScript 高级程序设计', 99.00, 4, 'Web 前端开发圣经，全面介绍 JavaScript 编程的核心概念和技术', 'https://img1.doubanio.com/view/subject/l/public/s8958650.jpg', '<p>本书是 JavaScript 经典图书的最新版，涵盖 JCMAScript 2019，全面涵盖 JavaScript 语言核心和 Jeb API。</p><p>书中详尽讲解了 JavaScript 的起源与历史、基本概念、语法、变量、数据类型、流控制语句、函数、面向对象编程、DOM、BOM、事件流、表单、JSON、Web API、性能优化、最佳实践等重要概念和技术。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '人类简史', 68.00, 5, '从人类进化的角度，重新讲述人类社会的发展历程', 'https://img3.doubanio.com/view/subject/l/public/s29850722.jpg', '<p>《人类简史》是以色列新锐历史学家尤瓦尔·赫拉利的一部重磅作品。这部书不同于传统的历史著作，它宏大的叙事将人类诞生于远古直至未来的发展娓娓道来。</p><p>作者以宏大的视角，重新讲述了人类的故事，打通了历史、人类学、生物学和经济学等学科的界限，不仅仅关注帝王将相，更关注普通人的日常生活；既详述人类发展的大趋势、大转折，也善于从小细节切入。</p>', NOW(), NOW()
        UNION ALL
        ...
        UNION ALL
        SELECT '瓦尔登湖', 38.00, 5, '梭罗的经典著作，记录了作者在瓦尔登湖畔的自然简朴生活', 'https://img3.doubanio.com/view/subject/l/public/s33758847.jpg', '<p>《瓦尔登湖》是美国作家亨利·戴维·梭罗创作的一部散文体著作，记录了作者在瓦尔登湖畔独居两年的生活体验。梭罗在书中详细记述了他在林中湖畔小屋的所见所闻所感，表达了他对简朴生活的推崇。</p><p>这部作品不仅是一部描写大自然的经典散文，更是一部哲理散文，表达了作者对人与自然和谐相处的思考，对物质社会带来的道德与生态问题的批判，以及对个人精神自由的向往与追求。</p>', NOW(), NOW()
        UNION ALL
